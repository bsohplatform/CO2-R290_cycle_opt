...
inputs_r290.DSH = 1.06
inputs_r290.DSC = 4.09
...
InEvap_co2 = ProcessFluid(Y={'air':1.0}, m=1.969, T=0.0, p=101300)
OutEvap_co2 = ProcessFluid(Y={'air':1.0}, m=1.969, T=0.0, p=101300)

InCond_r290 = ProcessFluid(Y={'water':1.0}, m=0.251, T=0.0, p=101300)
OutCond_r290 = ProcessFluid(Y={'water':1.0}, m=0.251, T=45+273.15, p=101300)
...
for amb_t in amb_Temp:
    ...
    T_tes_lb = CO2_dict['InEvap'].T
    T_tes_ub = R290_dict['OutCond'].T
    ...
    scop_array.append(result_array[-2])
