...
InCond_co2 = ProcessFluid(Y={'water':1.0}, m=0.0, T=40+273.15, p=101300)
OutCond_co2 = ProcessFluid(Y={'water':1.0}, m=0.0, T=50+273.15, p=101300)
...
result_array = []
dsc_array= [] 
CO2_dict["InEvap"].T = 7.598+273.15
CO2_dict["OutEvap"].T = CO2_dict["InEvap"].T-1
...
for temp in T_TES:
    CO2_dict["InEvap"].T = temp
    CO2_dict["OutEvap"].T = temp - 1.0
    CO2_dict["InCond"].m = 0.0
    CO2_dict["OutCond"].m = 0.0
